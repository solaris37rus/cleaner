...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: <Archive className="h-6 w-6 text-emerald-600" />,
      price: "300 ₽/шкаф",
    },
    {
      title: "Мытьё техники",
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Мы предлагаем полный спектр клининговых услуг для любых задач. Выбирайте то, что нужно именно вам.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm card-hover flex flex-col h-full"
            >
