      ...
      <div className="container-custom relative">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <div className="inline-flex items-center rounded-full bg-amber-100 border border-amber-200 px-3 py-1 text-sm font-bold text-amber-800 animate-pulse">
              🎁 Скидка 10% на первую уборку
            </div>
          </div>
